...
to consumirCombustivel
  ask combustiveis[
    ...
    if massa-combustivel <= massa-inicial - 0.2 [
      set color black
    ]
  ]
...
to criarCombustiveis
  create-combustiveis 1[
    if tipo-combustivel = "Amendoim" [
      set calor-latente calor-latente + 3133
      set shape "Amendoim"
      set color 12
      set size (0.1 * massa-inicial)
    ]
    if tipo-combustivel = "Nozes" [
      set calor-latente calor-latente + 3133
      set shape "Amendoim"
      set color 37
      set size (0.1 * massa-inicial)
    ]
    if tipo-combustivel = "Castanha" [
      set calor-latente calor-latente + 3133
      set shape "Amendoim"
      set color 39
      set size (0.1 * massa-inicial)
...
true
false
"" "set-plot-y-range massa-inicial - 0.5 massa-inicial\n\nask combustiveis [\n  create-temporary-plot-pen (word who)\n  set-plot-pen-color red\n  set massa-combustivel massa-combustivel - 0.0025\n  plotxy ticks massa-combustivel\n]"
PENS
