...
to aplica-temperatura-nas-fontes
  ask pedacosdechapa [
    if pcolor = 14.9 and fonte-quente-ligada = true [ set temperatura temperatura-fonte-quente ]
    if pcolor = 95.1 and fonte-fria-aplicada = true [ set temperatura 0 ]
  ]
...
to calcula-temperatura
  ask pedacosdechapa [
    if any? pedacosdechapa-on neighbors4 and pcolor != red [

      ;set heading random 360 ; futuramente o heading mostrará o fluxo de calor
      set temperatura mean [temperatura] of pedacosdechapa-on neighbors4
